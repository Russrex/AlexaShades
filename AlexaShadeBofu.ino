...
String device_name = "Shade";  // Name of device
...
//Pin setup for alexa shade RF Transmitter on D1
pinMode(5,OUTPUT);
digitalWrite(5,LOW);
...
delayMicroseconds(308);
digitalWrite(5,HIGH);
delayMicroseconds(5596);
digitalWrite(5,LOW);

Serial.print("Up/Off Signal Sent!");
    }
